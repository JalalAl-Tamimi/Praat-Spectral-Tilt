...
## Version 2: 09 March 2025. Uses the latest update in Praat's pitch analysis
...
for i from 1 to nbFiles
	...
	Remove
	selectObject: "Sound 'name$'"
	noprogress To Pitch (filtered autocorrelation): 0, minPitch, maxPitch, 15, "yes", 0.03, 0.09, 0.5, 0.055, 0.35, 0.14
	To PointProcess
